/*
  Rolf Niepraschk, Rolf.Niepraschk@gmx.de, 2015-06-19
*/

var net = require('net');
require('buffer').INSPECT_MAX_BYTES = 15000;
...
function rpc(clink, clbk) {
  ...
  var data = new Buffer(0), count = 0, expected = 0, lastFragment = false;
  ...
  function onData(chunk) {
    ...
    if (procedure == DEVICE_READ) {
      if (count == 1) {
        expected = chunk.readUInt32BE(LEN_OFFS);
      }
      if (!lastFragment) {
